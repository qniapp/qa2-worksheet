...
// ブロック紹介（名前・回転軸・回転量）
const INTRO_BLOCKS = [
  { group: 'まずは半周のブロック', g: 'X', name: 'X ブロック', start: N, fact: `${inlineGate('X')}ブロックは <b>＋マーク</b>。x軸で半周するよ。` },
  { g: 'Y', name: 'Y ブロック', start: N, fact: `Y軸で半周。${inlineGate('X')}ブロックと、まわる向きがちがうんだ。` },
...
const storyPage = () => `<div class="page">
  ...
  <div class="trythis">${furi(`🎮 やってみよう：QA² で <b>${inlineGate('X')}ブロックを2つ たてにそろえて</b>、ほんとうに消えるか たしかめてみよう！`)}</div>
